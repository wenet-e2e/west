...
@File   : configuration_transformer_adapter.py
"""
# coding=utf-8
...
class AdapterConfig(PretrainedConfig):
    ...
    [`AdapterModel`]. It is used to instantiate an Adapter model according to
    ...
    of Adapter-7B-beta
    [Qwen/Adapter-7B-beta](https://huggingface.co/Qwen/Adapter-7B-beta).
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 151936):
            Vocabulary size of the Adapter model. Defines the number of
            different tokens that can be represented by the `inputs_ids`
            passed when calling [`AdapterModel`]
        ...
        num_key_value_heads (`int`, *optional*, defaults to 32):
            ...
            When converting a multi-head checkpoint to a GQA checkpoint, each
            group key and value head should be constructed by meanpooling
            all the original heads within that group. For more details
            checkout [this paper](https://arxiv.org/pdf/2305.13245.pdf).
        ...
        rope_scaling (`Dict`, *optional*):
            ...
            embeddings.
            NOTE: if you apply new rope type and you expect the model to work on
            longer `max_position_embeddings`, we recommend you to update this
            value accordingly.
            Expected contents:
                `rope_type` (`str`):
                ...
                `factor` (`float`, *optional*):
                    ...
                    The scaling factor
                    to apply to the RoPE embeddings. In most scaling types, a
                    `factor` of x will enable the model to handle sequences of
                    length x * original maximum pre-trained length.
                ...
                `short_factor` (`List[float]`, *optional*):
                    Only used with 'longrope'. The scaling factor to be applied
                    to short contexts (< `original_max_position_embeddings`).
                    Must be a list of numbers with the same length as the hidden
                    size divided by the number of attention heads divided by 2
                `long_factor` (`List[float]`, *optional*):
                    Only used with 'longrope'. The scaling factor to be applied
                    to long contexts (< `original_max_position_embeddings`).
                    Must be a list of numbers with the same length as the hidden
                    size divided by the number of attention heads divided by 2
        ...
        sliding_window (`int`, *optional*, defaults to 4096):
            Sliding window attention (SWA) window size. If not specified,
    ...
    >>> # Initializing a Adapter style configuration
    >>> configuration = AdapterConfig()

    >>> # Initializing a model from the Adapter-7B style configuration
    >>> model = AdapterModel(configuration)
    ...
    # Default tensor parallel plan for base model `Adapter`
    base_model_tp_plan = {
