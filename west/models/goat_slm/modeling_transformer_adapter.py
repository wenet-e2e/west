        ...
        if self.config._attn_implementation != "eager":
            if self.config._attn_implementation == "sdpa" and kwargs.get(
                ...
                logger.warning_once(
                    ...
                    "Falling back to eager attention. This warning can be removed using the "
...
class AdapterModel(PreTrainedModel):
    ...
    _no_split_modules = ["AdapterEncoderLayer"]
    ...
    """
    Transformer decoder consisting of *config.num_hidden_layers* layers. Each layer is a [`AdapterEncoderLayer`]
    ...
    def _update_full_mask(
        ...
        # In case the provided `attention` mask is 2D, we generate a full mask here (4D).
        full_mask = self._prepare_4d_attention_mask(
            attention_mask,
