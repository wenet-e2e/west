...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        unit_embeds: Optional[torch.FloatTensor] = None,
        unit_mask=None,
...
class Qwen2ForCausalLM(Qwen2PreTrainedModel, GenerationWithCE, GenerationMixin):
    ...
    @deprecate_kwarg("num_logits_to_keep",
                     version="4.50",
