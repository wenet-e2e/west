...
class CosyVoice:
    ...
    def __init__(self, model_dir, load_jit=False, load_onnx=False, device_id=0):
        ...
        self.frontend = CosyVoiceFrontEnd(configs['get_tokenizer'],
                                          ...
                                          device_id=device_id)
        self.model = CosyVoiceModel(configs['llm'], configs['flow'], configs['hift'], device_id=device_id)
    ...
    def inference_sft(self, tts_text, spk_id, stream=False, speed=1.0):
        for i in tqdm(self.frontend.text_normalize(tts_text, split=True), disable=True):
