...
class CosyVoiceFrontEnd:
    ...
    def __init__(self,
        ...
        assert 'CUDAExecutionProvider' in onnxruntime.get_all_providers(), f"CUDAExecutionProvider not in {onnxruntime.get_all_providers()}"
    ...
    def _extract_speech_token(self, speech):
        ...
        feat = whisper.log_mel_spectrogram(speech, n_mels=128, device='cuda')
